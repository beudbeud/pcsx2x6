...
// regs (x22-x28), not just scratch, so the moves below preserve them where needed.
// RESTATEPTR(x19)/REFASTMEMBASE(x20)/REVTLBPTR(x21) are callee-saved and survive the C call.
