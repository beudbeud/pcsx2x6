...
struct microProgManager
{
	...
	u8*                codeEnd;            // Reset threshold (x86: x86end), mVUcacheSafeZone MB short of the physical end so a single in-flight compile can spill into the safe-zone and be caught afterward
