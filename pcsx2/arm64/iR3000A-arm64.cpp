...
static void recClearIOP(u32 Addr, u32 Size)
{
	...
	// ponytail: ARMSX2 dropped this arena-wide scope for per-site W^X
	// (armPatchCodeWord); our PatchAtomic still relies on the caller's scope,
	// and it is a no-op on Linux — keep it until we port their patch helper.
