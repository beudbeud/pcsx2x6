...
static bool recTranslateOp(u32 op, u32 pc)
{
	...
	switch (opcode)
	{
		...
		case 0x1A: armEmitLDL(rt, rs, imm); return true; // LDL
		case 0x1B: armEmitLDR(rt, rs, imm); return true; // LDR
		case 0x2C: armEmitSDL(rt, rs, imm); return true; // SDL
		case 0x2D: armEmitSDR(rt, rs, imm); return true; // SDR
